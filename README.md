...
- Supports `.mp4`, `.mkv`, `.mov`, and `.webm` inputs
...
- MKV, MOV, and WebM files can convert through `ffmpeg.wasm` when browser preview or browser metadata probing is unavailable.
